...
<script>
    ...
    const tableColumns = ['TimeTableId', 'ClassName', 'FacultyName', 'SubjectName', 'StartTimeToDisplay', 'EndTimeToDisplay', 'IsActive']
    const tableColumnsToDisplay = ['Id', 'Class Name', 'Faculty Name', 'Subject Name', 'StartTime', 'EndTime', 'Scheduled']
